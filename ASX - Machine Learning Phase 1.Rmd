...
The data set is incredibly right-skewed, as outlined by the summary table below of each variable. However, all the price variables (Close, High, Low, Open) appear to have similar measures of skew, kurtosis, and IQR.
